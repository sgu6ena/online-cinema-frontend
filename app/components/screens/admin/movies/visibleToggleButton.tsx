...
const VisibleToggleButton: FC<IVisibleToggle> = ({ isVisible, movieId }) => {
	...
	return (
		<button onClick={onClick}
						className={isLoadingVisible ? 'bg-gray-500 rounded p-3 w-24' : isActive ? 'bg-primary rounded font-bold bg-opacity-50 p-3 w-24' : 'bg-green-950 rounded font-bold bg-opacity-30 p-3 w-24'}
