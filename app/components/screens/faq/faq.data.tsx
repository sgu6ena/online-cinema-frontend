...
export const FAQ: { question: string, answer: ReactElement<any, any> }[] = [
...

	{
		...
		answer: <div>
			<ul>
				<li>	Стоимость подписки на 1 месяц – 32 рубля.</li>
				<li>	Стоимость подписки на 3 месяца -72 рубля.</li>
				<li>	Стоимость подписки на 6 месяцев – 128 рублей.</li>
			</ul>
			<p>
				Подписка продлевается автоматически на следующий период. Отказаться от подписки можно в любой момент, при этом подписка будет действовать до конца оплаченного периода.
			</p>
